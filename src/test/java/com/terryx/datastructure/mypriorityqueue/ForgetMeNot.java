...
/**
 * @author taoranxue on 2/14/18 10:13 PM.
 */
...
public class ForgetMeNot {
    private static void checkQ(MyPriorityQueue<Integer> q, Integer... elts) {
    ...
    private static void realMain(String[] args) throws Throwable {
        final MyPriorityQueue<Integer> q = new MyPriorityQueue<Integer>();
        Iterator<Integer> it;
